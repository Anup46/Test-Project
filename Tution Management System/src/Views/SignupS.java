...
public class SignupS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "English", "Bengali" }));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel7.setText("SignUp Page For Student");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String ok2 = (String)jComboBox2.getSelectedItem();
        ...
        if (res > 0) {
            ...
            this.dispose();
                ...
                {
                 new Register2B().setVisible(true);
            this.dispose();
